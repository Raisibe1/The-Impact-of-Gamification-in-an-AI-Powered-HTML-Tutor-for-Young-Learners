                ...
                ${
                    lesson.nextLesson
                        ...
                        <div class="next-lesson-container" style="display: flex; gap: 12px; justify-content: center; flex-wrap: wrap;">
                            ...
                            <button class="btn btn-primary" id="next-level-btn" style="display:none;" onclick="window.location.href='program.html'">
                                🚀 Next Level
                            </button>
                        </div>`
                        : `
                        <div class="completion-box">
                            ...
                            <div style="display: flex; gap: 12px; justify-content: center; flex-wrap: wrap; margin-top: 12px;">
                                ...
                                <button class="btn btn-success" onclick="window.location.href='test.html'">🚀 Next Level</button>
                            </div>
                        </div>`
                }
            </div>
